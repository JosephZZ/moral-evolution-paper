...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/Agent-Decision-Process.drawio.pdf}
  ...
  \begin{table*}[htbp]
    ...
    \begin{tabular}{p{2cm}p{3.5cm}p{3.5cm}p{3.5cm}}
      ...
      \midrule
      Selfish & Personal reproductive success, harm action allowed & Acquire resources for own survival; opportunistic tactics & Cooperate only when serving reproductive interests; inclined to hoard resources \\
      \bottomrule
    \end{tabular}
