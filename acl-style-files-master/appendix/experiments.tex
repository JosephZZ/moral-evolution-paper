...
2) Scenarios include Major Baseline, Scarce Resource, High Social Cost, Moral Invisible, and single-agent-type settings.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \hfill
    \caption{HP Gain and Loss by Action Type (Cases: major baseline and scarce resource)}
