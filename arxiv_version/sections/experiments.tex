...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/population_Abundant_resource.pdf}
        \caption{Agent type ratio and count over time}
    \end{subfigure}
    \hfill
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/population_Scarce_resource.pdf}
        \caption{Agent type ratio and count over time}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/population_single_type.pdf}
